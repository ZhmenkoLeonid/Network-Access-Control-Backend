...
public class NetflowUserStatisticMapper {
    ...
    public NetflowUserStatisticDto build(NetflowDeviceStatistic userStatistic) {
    ...
    public Map<String, NetflowUserStatisticDto> build(List<NetflowDeviceStatistic> userStatisticList) {
        Map<String, NetflowUserStatisticDto> userStatisticMap = new HashMap<>();

        for (NetflowDeviceStatistic userStatistic : userStatisticList) {
