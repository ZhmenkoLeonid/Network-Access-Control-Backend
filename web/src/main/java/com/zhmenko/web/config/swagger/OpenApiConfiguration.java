package com.zhmenko.web.config.swagger;
...
@OpenAPIDefinition(
        info = @Info(title = "User API", version = "${api.version}",
                contact = @Contact(name = "zmenko", email = "zhmenkowork@mail.ru", url = "https://github.com/ZhmenkoLeonid"),
                license = @License(name = "Apache 2.0", url = "https://www.apache.org/licenses/LICENSE-2.0"), termsOfService = "${tos.uri}",
                description = "${api.description}"),
        servers = {
                @Server(url = "https://localhost", description = "Development")})
//@formatter:on
